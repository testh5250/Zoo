...
//////////////////////////////////////////////////////////////////////////////////////////
    ...
    public void handleSave(){
        ...
        if(oldPass.getText().equals(manager.getPass())&&newPass.getText().equals(confirmPass.getText()))
            manager.setPass(newPass.getText());
        else
        ...
        managerName.setText("Manager: "+manager.getName()+" "+manager.getLastName());
    ...
    public void setManager(Manager manager) {
        ...
        managerName.setText(managerName.getText()+" "+manager.getName()+" "+manager.getLastName());

        firstNameField.setText(manager.getName());
        lastNameField.setText(manager.getLastName());
        phoneField.setText(manager.getPhoneNumber());
        mailField.setText(manager.getMail());
        addressField.setText(manager.getAddress());
        wageField.setText(manager.getWage()+"");
    }
